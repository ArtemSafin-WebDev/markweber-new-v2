...
export default function ContactUsModal() {
    ...
    const modalInner = contactUsModal.querySelector('.contact-us__inner');
    ...
    const openModal = () => {
        return gsap.to(window, {
            duration: 0.3,
            scrollTo: { y: contactUsModal, offsetY: OFFSET },
            onComplete: () => {
                ...
                return tl
                    ...
                    .to(
                        modalInner,
                        {
                            paddingTop: contactUsModal.getBoundingClientRect().top + parseFloat(window.getComputedStyle(modalInner).paddingTop)
                        },
                        0
                    );
            }
